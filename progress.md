...
- Latest visual QA screenshots inspected: `output/playwright/400-fpv-camera-latest.png` and `output/playwright/400-fpv-mobile-final-hud.png` (ignored artifacts).
