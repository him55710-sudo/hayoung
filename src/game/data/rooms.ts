...
export const rooms: Room[] = [
  {
    ...
    mood: "달빛 창, 촛불, 봉인된 편지, 네 개의 액자, 바이올린 진열장",
    palette: [0x2e5560, 0xd8b36a, 0x9fd8ff, 0x0c161c],
    accent: "#d8b36a",
    ambience: { label: "midnight theatre piano pad", base: 261.63, harmony: 329.63, pulse: 0.52 },
